...
class _HomePageState extends State<HomePage> {
  ...
  Future<void> loginUser() async {
    final url = Uri.parse('https://progres.mesrs.dz/api/authentification/v1');
    ...
    if (response.statusCode == 200) {
      ...
      Navigator.of(context).push(MaterialPageRoute(builder: (context) => const MyDashboard()));
    } else {
      // Handle error
      // ignore: avoid_print
                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        FadeInUp(
                          ...
                          child: ListTile(
                            onTap: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => const ForgottenPassword()));
                            },
                            title: const Text(
                              "Forgot Password?",
                          ...
                          child: MaterialButton(
                            ...
                            child: const Center(
                              child: ListTile(
                                title: Text(
                                  "Login",
                                  style: TextStyle(color: AppColors.PRIMARY_COLOR, fontWeight: FontWeight.bold),
                                ),
                              ),
                            ),
                          ),
                        ...
                        FadeInUp(
                          ...
                          child: MaterialButton(
                            onPressed: () {
                              Navigator.of(context).push(MaterialPageRoute(builder: (context) => const NoteDeBac()));
                            },
                            height: 50,
                            color: AppColors.BUTTON_COLOR,
                            shape: RoundedRectangleBorder(
